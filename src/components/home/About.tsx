...
const About = () => {
  ...
  return (
    <section id="about" className="about-section container mx-auto px-4 md:px-6 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          <div className="space-y-4">
            <p className="text-text-secondary">
              ...
              across the stack and have a strong foundation in modern frameworks.
            </p>
            <p className="text-text-secondary">
              My approach to development focuses on writing clean, maintainable code 
              that delivers exceptional user experiences. I enjoy solving complex 
          ...
          {/* Skills */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-text-primary">My Skills</h3>
            <div className="space-y-4">
